...
| File | Description |
|------|-------------|
| **`architecture-map.html`** | Full architecture map with animated layer diagrams, UML class diagrams, data flow visualizations, and ER diagrams |
| **`dev-dashboard.html`** | Developer dashboard with system status, metrics, deployment timeline, codebase stats, and activity feed |

## How to Use

Simply open any `.html` file in your browser — no server required. All assets are self-contained.
...
**TomCodeX Inc** · SentinelFlow · Zentom AI · Zentom Suite
